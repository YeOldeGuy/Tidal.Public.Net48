...
{
    /// <summary>
    ///   The three locations in a modern Windows file system that an app can
    ///   write to. These are typically in the <c>C:\Users\{username}\AppData</c>
    ///   directory.
    /// </summary>
    ...
    /// <summary>
    ///   Provides a common service for accessing files.
    /// </summary>
