...
namespace Tidal.Core.Collections
{
        ...
        IDictionaryEx<TKey, TValue>, IConcurrentDictionary<TKey, TValue>
    {
        ...
        /// <summary>
        /// Creates a LurchTable that orders items by (ordering) and removes
        /// items once the specified (limit) is reached.
        /// </summary>
        ...
        /// <summary>
        /// WARNING: not thread-safe, reinitializes all internal structures. Use
        /// Clear() for a thread-safe delete all. If you have externally
        /// provided exclusive access this method may be used to more
        ...
        /// cref="T:System.Collections.Generic.IDictionary`2"/> contains an
        ...
        /// method also returns false if <paramref name="key"/> was not found in
        /// the original <see
        /// cref="T:System.Collections.Generic.IDictionary`2"/>.
        /// </returns>
        ...
        /// <summary>
        /// Adds a key/value pair to the <see
        /// cref="T:System.Collections.Generic.IDictionary`2"/> if the key does
        /// not already exist, or updates a key/value pair if the key already
        /// exists.
        /// </summary>
        ...
        /// the factory method fnCreate will be called to produce the new value,
        /// if the key exists, the converter method fnUpdate will be called to
        ...
        /// <summary>
        /// Add, update, or fetche a key/value pair from the dictionary via an
        /// implementation of the <see
        /// cref="T:Downpour.CollectionsExt.ICreateOrUpdateValue`2"/> interface.
        /// </summary>
        ...
        /// <summary>
        /// Adds an element with the provided key and value to the <see
        /// cref="T:System.Collections.Generic.IDictionary`2"/> by calling the
        /// provided factory method to construct the value if the key is not
        ...
        /// <summary>
        /// Removes the element with the specified key from the <see
        /// cref="T:System.Collections.Generic.IDictionary`2"/> if the
        /// fnCondition predicate is null or returns true.
        /// </summary>
        ...
        /// <summary>
        /// Conditionally removes a key/value pair from the dictionary via an
        /// implementation of the <see
        /// cref="T:Downpour.CollectionsExt.IRemoveValue`2"/> interface.
        /// </summary>
        ...
        /// <summary>
        /// Retrieves the oldest entry in the collection based on the ordering
        ...
        private InsertResult Insert<T>(TKey key, ref T value) where T : ICreateOrUpdateValue<TKey, TValue>
        {
            ...
            if (added > _limit && Ordering != LurchTableOrder.None)
            {
